(function (blocks, editor, components, i18n, element) {
  ...
  registerBlockType('gutenberg/teacher-block', { // The name of our block. Must be a string with prefix. Example: my-plugin/my-custom-block.
    title: i18n.__('Teacher'), // The title of our block.
    description: i18n.__('A custom block for displaying teachers.'), // The description of our block.
    ...
    edit: function (props) {
      ...
      return [
        ...
        el('div', { className: props.className },
          el('div', {
            className: attributes.mediaID ? 'gutenberg-teacher-image image-active' : 'gutenberg-teacher-image image-inactive',
          ...
          el('div', { className: 'gutenberg-teacher-content', style: { textAlign: alignment } },
            el(RichText, {
              key: 'editable',
              tagName: 'h3',
            ...
            el('div', { className: 'gutenberg-teacher-social' },
    ...
    save: function (props) {
      ...
      return (
        el('div', { className: props.className },
          el('div', { className: 'gutenberg-teacher-image', style: { backgroundImage: 'url(' + attributes.mediaURL + ')' } },
            el('img', { src: attributes.mediaURL })
          ),
          el('div', { className: 'gutenberg-teacher-content', style: { textAlign: attributes.alignment } },
            el(RichText.Content, {
              tagName: 'h3',
              value: attributes.title
            }),
